...
var MaxRectsBin = /** @class */ (function (_super) {
    ...
    function MaxRectsBin(maxWidth, maxHeight, padding, options) {
        ...
        if (options === void 0) { options = { smart: true, pot: true, square: true, allowRotation: false, tag: false, border: 0, logic: PACKING_LOGIC.MAX_EDGE }; }
...
var MaxRectsPacker = /** @class */ (function () {
    ...
    function MaxRectsPacker(width, height, padding, options) {
        ...
        if (padding === void 0) { padding = 0; }
        if (options === void 0) { options = { smart: true, pot: true, square: false, allowRotation: false, tag: false, border: 0, logic: PACKING_LOGIC.MAX_EDGE }; }
        this.width = width;
        this.height = height;
    ...
    MaxRectsPacker.prototype.sort = function (rects, logic) {
        if (logic === void 0) { logic = PACKING_LOGIC.MAX_EDGE; }
        return rects.slice().sort(function (a, b) {
            var result = (logic === PACKING_LOGIC.MAX_EDGE) ?
